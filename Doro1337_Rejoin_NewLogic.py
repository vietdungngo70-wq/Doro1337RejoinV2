...
def rejoin(pkg,reason):
    ...
    print(YELLOW+f"⚡ Rejoining {pkg} ({reason})"+RESET)
...
def status_loop():
    ...
    while running:
        ...
        for pkg in packages:
            ...
            lines.append(
                f"{pkg:<24} | {status:<6} | {cpu:>3}% | {ram:<4} | {rj}"
            )
        ...
        if screen!=last_screen:
            os.system("clear")
            print(MAGENTA+"╔══════════════════════════════════════════════════════╗"+RESET)
            print(MAGENTA+"║        🚀 DORO1337 REJOIN PRO - ICON EDITION 🚀      ║"+RESET)
            print(MAGENTA+"╚══════════════════════════════════════════════════════╝"+RESET)
...
def start():
    ...
    for pkg in packages:
        ...
        print(CYAN+f"🚀 Launching {pkg}..."+RESET)
        open_game(pkg)
        time.sleep(1)
